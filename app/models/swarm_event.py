...
class SwarmEvent(Base):
    ...
    __table_args__ = (
        UniqueConstraint("swarm_run_id", "seq", name="uq_swarm_events_run_seq"),
        Index("idx_swarm_events_run_seq", "swarm_run_id", "seq"),
        Index("idx_swarm_events_type_created_at", "event_type", "created_at"),
    )
