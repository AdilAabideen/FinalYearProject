...
class SwarmRunMetrics(Base, TimestampMixin):
    __tablename__ = "swarm_run_metrics"

    swarm_run_id: Mapped[str] = mapped_column(
        String,
    ...
    __table_args__ = (
        Index("idx_swarm_run_metrics_status_created", "status", "created_at"),
    )
