...
class MasTestRun(Base, TimestampMixin):
    __tablename__ = "mas_test_runs"
    ...
    __table_args__ = (
        Index("idx_mas_test_runs_workflow_created_at", "workflow_id", "created_at"),
    )
