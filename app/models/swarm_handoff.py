...
class SwarmHandoff(Base, TimestampMixin):
    ...
    __table_args__ = (
        Index("idx_swarm_handoffs_swarm_created_at", "swarm_run_id", "created_at"),
        Index("idx_swarm_handoffs_from_run_created_at", "from_agent_run_id", "created_at"),
        Index("idx_swarm_handoffs_to_agent_created_at", "to_agent_name", "created_at"),
        Index("idx_swarm_handoffs_status_created_at", "status", "created_at"),
    )
