...
import type {AgentsLoadState, HeaderOverride, AgentDetailState} from "./AgentsPage"



type SingleAgentPageProps = {
  onHeaderChange?: (override: HeaderOverride | null) => void;
};

// Renders the agents page.
export function SingleAgentsPage({ onHeaderChange }: SingleAgentPageProps) {
